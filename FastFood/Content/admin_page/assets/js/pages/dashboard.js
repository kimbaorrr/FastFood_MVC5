var options = {
    ...
    plotOptions: {
        radialBar: {
            ...
            endAngle: 135,
            dataLabels: {
                name: { fontSize: "14px", color: "undefined", offsetY: 100 },
                value: {
                    offsetY: 55,
                    fontSize: "20px",
                    color: void 0,
    ...
    fill: { gradient: { enabled: !0, shade: "dark", shadeIntensity: 0.2, inverseColors: !1, opacityFrom: 1, opacityTo: 1, stops: [0, 50, 65, 91] } },
    stroke: { dashArray: 4 },
...
options = {
    ...
    fill: { opacity: [1, 1], type: ["solid", "gradient"], gradient: { type: "vertical", inverseColors: !1, opacityFrom: 0.5, opacityTo: 0, stops: [0, 90] } },
    ...
    grid: { show: !0, strokeDashArray: 3, xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } }, padding: { top: 0, right: -2, bottom: 0, left: 10 } },
...
class VectorMap {
    initWorldMapMarker() {
        new jsVectorMap({
            ...
            markerStyle: { initial: { fill: "#7f56da" }, selected: { fill: "#22c55e" } },
